...
const DrapedByAtulya = () => {
  return (
    <section className="py-12  w-full text-center bg-white">
      <h2 className="text-2xl font-[Kalnia] text-#052A3D">Draped by Atulya Karigari</h2>
      ...
      <div className=" grid grid-cols-1 md:grid-cols-3 gap-6 lg:px-24 px-6 mx-auto">
        {drapedImages.map((item, index) => (
          ...
          >
            ...
            />
            {item.isFeatured && (
              <div className="absolute bottom-4 left-4 flex items-center bg-white px-3 py-1 rounded-full shadow-md gap-2">
